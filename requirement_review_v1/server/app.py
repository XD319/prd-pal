...
def _build_report_html(*, run_id: str, report_payload: dict[str, Any], report_md: str, run_dir: Path) -> str:
...
def _build_report_csv(report_payload: dict[str, Any]) -> str:
...
async def get_report(run_id: str, format: Literal["md", "json", "html", "csv"] = Query(default="md")) -> Response:
    ...
    if format == "html":
        ...
        html_content = _build_report_html(run_id=run_id, report_payload=report_payload, report_md=report_md, run_dir=run_dir)
        return Response(
